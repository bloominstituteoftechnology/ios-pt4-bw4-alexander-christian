...
//  Vortex Mortgage
//
//  Created by Alex Thompson on 6/20/20.
    ...
    public var body: some View {
        ZStack{
            Rectangle()
                ...
                .cornerRadius(20)
                .shadow(color: self.style.dropShadowColor, radius: self.dropShadow ? 20 : 0)
...
struct PieChartView_Previews : PreviewProvider {
    static var previews: some View {
        PieChartView(data:[56,78,53,65,54], title: "Swift is cool", legend: "House payment")
    }
}
#endif
